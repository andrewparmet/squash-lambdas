plugins {
    ...
    alias(libs.plugins.awsKotlinDynamoDbMapper)
...
dependencies {
    ...
    implementation(libs.aws.kotlin.dynamodb.mapper)
    implementation(libs.aws.kotlin.dynamodb.mapper.annotations)
    implementation(libs.aws.kotlin.s3)
    implementation(libs.aws.kotlin.sns)
...
tasks.withType<Test> {
    ...
    environment("GOOGLE_CALENDAR_ID", "test-calendar-id")
