...
public class EmailRetrieverTest {
  ...
  public static VEvent event() {
    ...
    event.setOrganizer(new Organizer("Tennis & Racquet Club", "redacted@example.com"));
  ...
  public static Attendee attendee() {
    Attendee attendee = new Attendee("Repository Author", "redacted@example.com");
  ...
  public static EmailData emailData() {
    return new EmailData(
        ...
        "Hello Repository Author, A reservation including you has been made via the Tennis & Racquet Club "
